...
package ph.gov.philfida.da.abacaplanddiseasedeteciontapplayout.env;
...
/**
 * Wrapper for platform Log function, allows convenient message prefixing and Log disabling.
 */
public class Logger {
    ...
    /**
     * Creates a Logger using class name as a message prefix
     *
     * @param clazz the sample name of this class is used as the message prefix.
     */
     ...
     * @param messagePrefix prepended to every message if non-null. If non-null, the name of caller is
     *                      being used.
     */
     ...
     *
     * <p> Android StackTrace() returns an array that looks like this: stackTrace[0]:
     ...
     *
     * <p>this fumction returns the simple version of the first non-filtered name.
     *
     * @return caller's simple name
     */
    private String getCallerSimpleName() {
        //Get the current callback so we can call the class of the caller off it.
